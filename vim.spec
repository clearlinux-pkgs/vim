...
Version  : 9.0.0424
Release  : 2866
URL      : https://github.com/vim/vim/archive/v9.0.0424/vim-9.0.0424.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.0424/vim-9.0.0424.tar.gz
...
%prep
%setup -q -n vim-9.0.0424
cd %{_builddir}/vim-9.0.0424
%patch1 -p1
%patch2 -p1
pushd ..
cp -a vim-9.0.0424 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662734620
