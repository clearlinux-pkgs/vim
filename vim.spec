...
Version  : 9.0.1504
Release  : 3520
URL      : https://github.com/vim/vim/archive/v9.0.1504/vim-9.0.1504.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1504/vim-9.0.1504.tar.gz
...
%prep
%setup -q -n vim-9.0.1504
cd %{_builddir}/vim-9.0.1504
%patch1 -p1
%patch2 -p1
pushd ..
cp -a vim-9.0.1504 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682981001
