...
Version  : 9.0.1434
Release  : 3476
URL      : https://github.com/vim/vim/archive/v9.0.1434/vim-9.0.1434.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1434/vim-9.0.1434.tar.gz
...
%prep
%setup -q -n vim-9.0.1434
cd %{_builddir}/vim-9.0.1434
%patch1 -p1
%patch2 -p1
pushd ..
cp -a vim-9.0.1434 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680356338
