...
Source0  : https://github.com/vim/vim/archive/v9.1.1552/vim-9.1.1552.tar.gz
...
%prep
%setup -q -n vim-9.1.1552
cd %{_builddir}/vim-9.1.1552
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a vim-9.1.1552 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752619967
