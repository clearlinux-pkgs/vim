...
Version  : 8.2.4159
Release  : 2095
URL      : https://github.com/vim/vim/archive/v8.2.4159/vim-8.2.4159.tar.gz
Source0  : https://github.com/vim/vim/archive/v8.2.4159/vim-8.2.4159.tar.gz
...
%prep
%setup -q -n vim-8.2.4159
cd %{_builddir}/vim-8.2.4159
%patch1 -p1
%patch2 -p1
pushd ..
cp -a vim-8.2.4159 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642693257
...
cp %{_builddir}/vim-8.2.4159/LICENSE %{buildroot}/usr/share/package-licenses/vim/100dd019c7d2912226c94666cac0f93eeb82a518
cp %{_builddir}/vim-8.2.4159/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/vim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.2.4159/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/vim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.2.4159/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/vim/553dde2683f711f77fe79504be0429256223469d
pushd ../buildavx2/
%make_install_v3
popd
%make_install
