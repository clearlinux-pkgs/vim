...
Source0  : https://github.com/vim/vim/archive/v9.0.1467/vim-9.0.1467.tar.gz
...
%prep
%setup -q -n vim-9.0.1467
cd %{_builddir}/vim-9.0.1467
%patch1 -p1
%patch2 -p1
pushd ..
cp -a vim-9.0.1467 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681848461
