...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649944489
...
cp %{_builddir}/vim-8.2.4748/LICENSE %{buildroot}/usr/share/package-licenses/vim/100dd019c7d2912226c94666cac0f93eeb82a518
cp %{_builddir}/vim-8.2.4748/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/vim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.2.4748/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/vim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.2.4748/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/vim/553dde2683f711f77fe79504be0429256223469d
pushd ../buildavx2/
%make_install_v3
popd
%make_install
