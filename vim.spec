...
Version  : 9.1.1565
Release  : 4437
URL      : https://github.com/vim/vim/archive/v9.1.1565/vim-9.1.1565.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.1565/vim-9.1.1565.tar.gz
...
%prep
%setup -q -n vim-9.1.1565
cd %{_builddir}/vim-9.1.1565
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a vim-9.1.1565 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752867800
