...
Version  : 9.1.1538
Release  : 4426
URL      : https://github.com/vim/vim/archive/v9.1.1538/vim-9.1.1538.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.1538/vim-9.1.1538.tar.gz
...
%prep
%setup -q -n vim-9.1.1538
cd %{_builddir}/vim-9.1.1538
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a vim-9.1.1538 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752263138
