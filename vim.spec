...
Version  : 8.2.0143
Release  : 1057
URL      : https://github.com/vim/vim/archive/v8.2.0143/vim-8.2.0143.tar.gz
Source0  : https://github.com/vim/vim/archive/v8.2.0143/vim-8.2.0143.tar.gz
...
%prep
%setup -q -n vim-8.2.0143
cd %{_builddir}/vim-8.2.0143
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579797863
...
cp %{_builddir}/vim-8.2.0143/src/libvterm/LICENSE %{buildroot}/usr/share/package-licenses/vim/9979f112bdecefd99762f24f6af76972c2a3a1a6
cp %{_builddir}/vim-8.2.0143/src/xdiff/COPYING %{buildroot}/usr/share/package-licenses/vim/65c71b7ff77a59a32247d83a528728637263c1b5
cp %{_builddir}/vim-8.2.0143/src/xpm/COPYRIGHT %{buildroot}/usr/share/package-licenses/vim/553dde2683f711f77fe79504be0429256223469d
%make_install
