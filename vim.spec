...
Version  : 9.0.1805
Release  : 3675
URL      : https://github.com/vim/vim/archive/v9.0.1805/vim-9.0.1805.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.0.1805/vim-9.0.1805.tar.gz
...
%prep
%setup -q -n vim-9.0.1805
cd %{_builddir}/vim-9.0.1805
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a vim-9.0.1805 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693158093
