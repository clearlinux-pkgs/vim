...
Version  : 9.1.0563
Release  : 4028
URL      : https://github.com/vim/vim/archive/v9.1.0563/vim-9.1.0563.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.0563/vim-9.1.0563.tar.gz
...
%prep
%setup -q -n vim-9.1.0563
cd %{_builddir}/vim-9.1.0563
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a vim-9.1.0563 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720729506
