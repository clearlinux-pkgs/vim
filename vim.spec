...
Source0  : https://github.com/vim/vim/archive/v9.0.1765/vim-9.0.1765.tar.gz
...
%prep
%setup -q -n vim-9.0.1765
cd %{_builddir}/vim-9.0.1765
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a vim-9.0.1765 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692551956
