...
Version  : 9.1.1057
Release  : 4245
URL      : https://github.com/vim/vim/archive/v9.1.1057/vim-9.1.1057.tar.gz
Source0  : https://github.com/vim/vim/archive/v9.1.1057/vim-9.1.1057.tar.gz
...
%prep
%setup -q -n vim-9.1.1057
cd %{_builddir}/vim-9.1.1057
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a vim-9.1.1057 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738334245
...
/usr/share/vim/vim91/pack/dist/opt/netrw/autoload/netrw/own.vim
